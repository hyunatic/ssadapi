...
$app->post('/api/student/completed/tut', function(Request $request, Response $response){
    ...
    $tsql = "Select id, tutname, MAX(score) AS maxscore, date, name, leaderboard.tutid from leaderboard, tutorial WHERE leaderboard.tutid = tutorial.tutid AND leaderboard.studid = '$studid' AND score != '' GROUP BY tutname ORDER BY score DESC";
...
$app->post('/api/competitor', function(Request $request, Response $response){
    $studid = $request->getParam('studid');
    $tutid = $request->getParam('tutid');

    $tsql = "SELECT * From leaderboard WHERE tutid = '$tutid' AND studid = '$studid' ORDER BY score DESC LIMIT 1";
...
$app->post('/api/user/competitor', function(Request $request, Response $response){
    $leaderboardid = $request->getParam('leaderboardid');

    $tsql = "SELECT * From leaderboard WHERE id = '$leaderboardid'";
